...
# Now add stations
import pandas as pd
stations = pd.read_csv("/Volumes/TOSHI/NANT/NoisePy-ant-main/smartsolo/QC/station_locations_days_ALL.csv")
...
#plt.show()
plt.savefig('ML_deployed_days.png',bbox_inches='tight')
#plt.close()
